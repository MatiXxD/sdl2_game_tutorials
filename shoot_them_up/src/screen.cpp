...
Screen::Screen(int w, int h) : renderer(nullptr), window(nullptr), width(w), height(h) {
    ...
    window = SDL_CreateWindow("Shoot them up", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
                              width, height, 0);
    if(!window) {
